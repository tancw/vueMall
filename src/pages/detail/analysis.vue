<template>
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-counter @on-change="onParamChange('buyNum', $event)" :max="100" :min="10"></v-counter>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
    ...
    <my-dialog :is-show="isShowPayDialog" @on-close="closePayDialog">
      ...
      <bank-chooser @on-change="onChangeBanks">xxx</bank-chooser>
    ...
    <check-order :is-show-check-dialog="isShowCheckOrder" :order-id="orderId" @on-close-check-dialog="closeCheckOrder"></check-order>
  </div>
</template>
